...
import com.android.internal.telephony.OperatorInfoSprd;
 ...
 */
oneway interface INetworkQueryServiceCallbackSprd {
     ...
     */
    void onQueryComplete(in List<OperatorInfoSprd> networkInfoArray, int status);
